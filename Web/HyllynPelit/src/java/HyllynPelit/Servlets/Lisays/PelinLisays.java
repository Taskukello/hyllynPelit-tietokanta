...
public class PelinLisays extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("PelinLisaysLook");
        ...
        if (uusiPeli.onkoKelvollinen() == true) {
            if (Peli.haePelitNimella(request.getParameter("PelinNimi")).isEmpty()) {
                ...
                virheet.add("Peli " + request.getParameter("PelinNimi") + " on jo tietokannassa!");
