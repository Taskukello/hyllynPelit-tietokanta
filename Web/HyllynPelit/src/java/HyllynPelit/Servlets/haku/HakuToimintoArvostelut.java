 ...
 * @author Aki
 */
public class HakuToimintoArvostelut extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Arvostelu> arvostelu = Arvostelu.haeArvostelutHakuSanalla(haku);
        UudelleenOhjaus ohjaus = new UudelleenOhjaus("hakuLista");
        ohjaus.setArvostelu(arvostelu);
        session.setAttribute("hakuTulos", ohjaus);
        
        response.sendRedirect("HakuTuloksetArvostelut");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(HakuToimintoArvostelut.class.getName()).log(Level.SEVERE, null, ex);
