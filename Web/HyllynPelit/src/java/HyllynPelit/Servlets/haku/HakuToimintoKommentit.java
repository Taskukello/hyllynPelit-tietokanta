...
import HyllynPelit.Servlets.Kommentit;
import HyllynPelit.Servlets.Kommentti;
 ...
 * @author Aki
 */
public class HakuToimintoKommentit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<KommentinHaku> kommentit = KommentinHaku.getKommentitHakuSanalla(haku);
        UudelleenOhjaus ohjaus = new UudelleenOhjaus("hakuLista");
        ohjaus.setKommentit(kommentit);
        session.setAttribute("hakuTulos", ohjaus);
        
        response.sendRedirect("HakuTuloksetKommentit");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(HakuToimintoKommentit.class.getName()).log(Level.SEVERE, null, ex);
